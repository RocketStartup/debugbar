...
class View{
	...
	public function getHistoryTime(){
		...
		$r.='],';
			...
			$d.='												], label: "Total",borderColor: "#3e95cd",fill: false';
			$d.='											},';
			$d.='											{ ';
			$d.='												data: [';
	...
	public function showBar(){
		...
		$r.='</div>';
		$r.='<style>';
		$r.=' html{ padding-bottom:25px;} .sdbrdt table.mntb { width: 100%; font-size: 12px; font-family: monospace; position: fixed; left: 0px; bottom: 0px; text-align: center; background: #333; color: #ddd; border-top: 1px solid #393939;  } .sdbrdt table.mntbopen { width: 100%; height: 150px; font-size: 12px; font-family: monospace; position: fixed; left: 0px; bottom: 28px; text-align: left; background: #444444; color: #ddd; border-top: 1px solid #444444;  } .icbr{ height: 25px; padding: 3px 0px; display: block; background: none; cursor: pointer; text-align: center;} .icbr:hover,.icbractive{ background: rgba(100, 100, 100, .2); } .icbr img{ height: 17px;  } .icbr span{ position: relative; top: 2px; color: #ddd; } .clbr{ width: 10px; height: 15px; background: #333333; display: block; float: left; margin-right: 5px;} .clbr1{ background: royalblue;} .clbr2{ background: salmon;} .clbr3{ background:springgreen;} .clbr4{ background: teal;} .clbr5{ background: slateblue;} .mntbopen{ display: none;} .mntbopen p.titlebar{ font-size: 18px; margin: 0px; color: #FFFFFF; margin-bottom: 8px;} .mntbopen p.titlebar img{ top: 1px; position: relative;} .scllcd{ height: 145px; overflow-y: scroll; background: #333; border-radius: 3px; padding-left: 10px;} .scllcd code{ font-size: 10px;} .headerbarcomands{ float: right; width: 100px;} .headerbarcomands a{ float: right; margin-left: 10px; background: rgba(10,10,10,.2); padding: 0px 5px;} .headerbarcomands img{ width:12px;} .sdbrdt ::-webkit-scrollbar { width: 8px;} .sdbrdt ::-webkit-scrollbar-track { background: #f1f1f1;  } .sdbrdt ::-webkit-scrollbar-thumb { background: #888; } .sdbrdt ::-webkit-scrollbar-thumb:hover { background: #555;}';
		$r.='</style>';
		$r.='<script>';
